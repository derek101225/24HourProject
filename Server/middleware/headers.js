module.exports =(req,res,next) =>{
    res.header('access-control-allow-origin', '*');// tells the browser to aloow code from any origin.
    res.header('access-control-allow-methods', 'GET, POST, PUT, DELETE');// specifies the method(s) allowed when accessing the resource in the response to a prefilght request
